...
/* The defaults.h file serves as a central default settings selector for different machine
...
#ifdef GENERIC_3018
  // Configuration for the Generic 3018-style machines

  // disable variable spindle support
  #ifdef VARIABLE_SPINDLE
  #undef VARIABLE_SPINDLE
  #endif
  ...
  #define DEFAULT_Y_ACCELERATION (10.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_Z_ACCELERATION (10.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_X_MAX_TRAVEL 280.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_Y_MAX_TRAVEL 140.0 // mm NOTE: Must be a positive value.
  ...
  #define DEFAULT_STEPPER_IDLE_LOCK_TIME 25 // msec (0-254, 255 keeps steppers enabled)
  #define DEFAULT_STATUS_REPORT_MASK 2 // $10, buffer full
  #define DEFAULT_JUNCTION_DEVIATION 0.01 // mm
  #define DEFAULT_ARC_TOLERANCE 0.002 // mm
  #define DEFAULT_REPORT_INCHES 0 // false
  #define DEFAULT_INVERT_ST_ENABLE 0 // false
